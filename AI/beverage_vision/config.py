...
CLS_EMB = os.getenv("CLS_EMB", str(ROOT / "best_cls_embed_effb0.pt"))
CLS_PROTOS = os.getenv("CLS_PROTOS", str(ROOT / "prototypes_effb0.pt"))
CLS_TAU = os.getenv("CLS_TAU", str(ROOT / "tau_effb0.json"))
